...
Todos los métodos implementados derivan de una clase maestra denominada `{python} _random_generator`. Dada la naturaleza disimila de PRNG cada generador derivado de esta clase padre debe implementar el método `{python} rand` el cual debe generar un (único) número pseudoaleatorio. En esta clase se implementa el método `{python} sample` 
